...
youtubeDashApp = Dash(__name__, server=app, url_base_pathname='/tube_dashboard/', external_stylesheets=external_stylesheets)
youtubeDashApp.layout= youtube_dash.build_education_dash
ehdenDashApp = Dash(__name__, server=app, url_base_pathname='/educ_dashboard/', external_stylesheets=external_stylesheets)
