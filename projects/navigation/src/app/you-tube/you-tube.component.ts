  ...
  layout = this.breakpointObserver.observe([Breakpoints.XSmall, Breakpoints.Small, Breakpoints.Medium]).pipe(
    map(({ breakpoints }) => {
      if (breakpoints[Breakpoints.XSmall]) {
        return {
          columns: ['title', 'publishedAt', 'latestViewCount'],
          tiles: [
        ...
        return {
          columns: ['title', 'publishedAt', 'latestViewCount', 'termFreq'],
          tiles: [
        ...
        return {
          columns: ['title', 'publishedAt', 'duration', 'latestViewCount', 'termFreq'],
          tiles: [
