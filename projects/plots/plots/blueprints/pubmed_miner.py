...
bp = Blueprint('pubmed_miner', __name__)

@bp.route('/mine_pubmed/', methods = ['POST', 'GET'])
def update_data():
...
def checkAuthorRecord(newArticleTable, currentAuthorSummary, monthlyUpdate = False):
    ...
    placeHolder = []
    faPlaceHolder = []
    if 'uniqueAuthors' in currentAuthorSummary: # unless first run
