...
class MockCosmos:
        ...
        if 'parameters' in kwargs:
            for p in kwargs['parameters']:
                if p['name'] == '@id':
                    id = p['value']
                    break
        fixture = 'projects/plots/plots/test/pub_med_fixture.json'
    ...
    def youtube_as_cosmos():
        fixture = 'projects/plots/plots/test/you_tube_fixture.json'
        for r in json.load(open(fixture)):
            d = {}
            d['id'] = r['id']
            n = r['Title']
    ...
    def youtube_dashboard_as_cosmos():
        fixture = 'projects/plots/plots/test/you_tube_dashboard_fixture.json'
    ...
    def ehden_dashboard_as_cosmos():
        ...
        def course_stats():
            fixture = 'projects/plots/plots/test/ehden_fixture.json'
    ...
    def pubmed_authors_as_cosmos():
        cumulative = json.load(open('projects/plots/plots/test/pub_med_cumulative_authors.json'))
        new = json.load(open('projects/plots/plots/test/pub_med_new_authors.json'))
